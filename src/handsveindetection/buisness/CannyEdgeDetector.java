...
//		  detector.setHighThreshold(1f);
//		  //apply it to an image
//		  detector.setSourceImage(ImageIO.read(new File("C:\\Documents and Settings\\amarnath.poddar\\My Documents\\Downloads\\color.jpg")));
//		  detector.process();
//		  BufferedImage edges = detector.getEdgesImage();
//		  ImageIO.write(edges, "jpg", new File("coloredge.jpg"));
//		  System.out.println("Edge Created");
//		 
//	}
