...
public class HistogramEQ {
    ...
    try{
        ...
        String output_f = dir+properties.getProperty("histogramimage");
...
// 
//        File original_f = new File("C:\\Documents and Settings\\amarnath.poddar\\My Documents\\Downloads\\test.jpg");
//        String output_f = "C:\\Documents and Settings\\amarnath.poddar\\My Documents\\Downloads\\test10";//args[1];
//        original = ImageIO.read(original_f);
//        equalized = histogramEqualization(original);
//        writeImage(output_f);
// 
